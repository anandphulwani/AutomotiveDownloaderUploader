...
IF NOT EXIST "..\autodown_datastore" mkdir "..\autodown_datastore"

IF NOT EXIST "..\autodown_datastore\Bookmarks_Blank" echo  > %TEMP%\temp.b64 && certutil -decode -f %TEMP%\temp.b64 ..\autodown_datastore\Bookmarks_Blank && del %TEMP%\temp.b64
IF NOT EXIST "..\autodown_datastore\Bookmarks" (
    IF EXIST "..\autodown_datastore\Bookmarks_Blank" (
        xcopy /E /I /Y "..\autodown_datastore\Bookmarks_Blank" "..\autodown_datastore\Bookmarks"
    )
)
